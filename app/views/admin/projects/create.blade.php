...
@section('content')
	...
	<div class="row  border-bottom white-bg dashboard-header">
		<div class="col-sm-12">
			{{ Form::open(['action' => 'ProjectsController@store', 'class' => 'form-horizontal', 'files' => true]) }}
			        ...
			        <div class="col-lg-offset-2 col-lg-10">
			            <div class="i-checks">
				            ...
				            @if(count($customers) == 0)
				            	{{ Form::checkbox('create_new_customer', 1, true, ['id' => 'create_new_customer']) }}
				            	Create New Customer
				            @else
			        ...
			        <div class="col-lg-offset-2 col-lg-10">
			            <div class="i-checks">
				            ...
				            @if(count($categories) == 0)
				            	{{ Form::checkbox('create_new_category', 1, true, ['id' => 'create_new_category']) }}
				            	Create New Category
				            @else
